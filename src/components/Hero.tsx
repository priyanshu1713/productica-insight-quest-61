  ...
  return (
    <section className="relative pt-20 pb-28 overflow-hidden min-h-[90vh] flex items-center">
      ...
      <div className="absolute inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-b from-productica-dark/90 via-productica-dark to-productica-black/90"></div>
        
        {/* Space for background image - it will be added by the user */}
        <div className="absolute inset-0 bg-center bg-cover z-[-1]"></div>
        
        {/* Decorative Elements */}
        <div className="absolute top-20 right-10 w-64 h-64 bg-white/5 rounded-full blur-3xl opacity-20 animate-blob"></div>
        <div className="absolute bottom-20 left-10 w-80 h-80 bg-white/5 rounded-full blur-3xl opacity-20 animate-blob" style={{ animationDelay: "2s" }}></div>
        
        {/* Glass overlay for text readability */}
        <div className="absolute inset-0 backdrop-blur-sm bg-productica-black/30"></div>
      </div>
      ...
      <div className="container mx-auto relative z-10">
        <div className="flex flex-col items-center text-center max-w-4xl mx-auto">
          <div className="glass-primary rounded-full px-4 py-1.5 inline-flex items-center mb-6 animate-fade-in">
            <div className="w-2 h-2 rounded-full bg-white mr-2 animate-pulse-slow"></div>
          ...
          <h1 className="fancy-heading mb-8 animate-fade-in">
            ...
            <span className="text-white block mt-2">Market-Ready</span>
          ...
          <div className="animate-fade-in relative glow">
            <Button size="lg" className="bg-white hover:bg-gray-200 text-productica-dark shadow-lg transition-all">
          ...
          <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 w-full">
            <div className="glass-card rounded-lg p-6 transition-all duration-300 hover:bg-productica-dark-hover">
              <div className="text-white text-xl font-bold mb-2">93%</div>
              <p className="text-gray-400 text-sm">Accuracy in market trend predictions</p>
            </div>
            <div className="glass-card rounded-lg p-6 transition-all duration-300 hover:bg-productica-dark-hover">
              <div className="text-white text-xl font-bold mb-2">10,000+</div>
              <p className="text-gray-400 text-sm">Products analyzed successfully</p>
            </div>
            <div className="glass-card rounded-lg p-6 transition-all duration-300 hover:bg-productica-dark-hover">
              <div className="text-white text-xl font-bold mb-2">24/7</div>
